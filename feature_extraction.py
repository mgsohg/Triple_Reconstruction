...
'''Note that,for the variable "dual", you can selectively load  a specific model either 2nd level nework or 3rd level. You have to extract both of them separately. '''
